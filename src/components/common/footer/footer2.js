...
class Footer extends React.Component {
  render() {
    return (
        ...
        <div className="flex justify-center flex-grow bg-white mb-11">
          <div className="flex flex-col items-center p-10 pt-5 text-center text-gray-800 bg-gray-100 rounded-lg mt-11">
            <h1 className="text-4xl font-bold">Let's Go!</h1>
            <p className="text-lg font-['Arial', sans-serif] p-8 max-w-3xl">
              So why wait? Sign up now and start crafting your own incredible
              stories today!
            </p>
