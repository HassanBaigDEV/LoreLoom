  ...
  return (
    <div className="container p-6 mx-auto">
      ...
      <div className="p-6 rounded-lg shadow bg-gray-50">
        <h3 className="mb-4 text-xl font-semibold text-gray-700">Subscription Plan</h3>
        <p className="mb-6 text-gray-600">See billing information regarding your current plan</p>
        <div className="flex items-center p-4 bg-gray-100 rounded-lg shadow-inner">
          ...
          <div>
            ...
            <a href="/upgrade" className="inline-block mt-2 font-semibold text-blue-500">
              Upgrade Plan +
            </a>
          </div>
        </div>
