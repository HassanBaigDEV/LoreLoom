      ...
      <DialogContent sx={{ p: 3, pt: 2 }}>
                ...
                <Grid item xs={12} sm={6} key={outline.number}>
                  <Paper
                    ...
                    sx={{
                      ...
                      border:
                        selectedOutline === outline.number
        ...
        {step === 2 && (
          <>
            ...
            <Paper
              elevation={1}
              sx={{ p: 3, mb: 3, bgcolor: "rgba(34, 197, 94, 0.05)" }}
            >
              <Typography variant="subtitle2" gutterBottom>
                Selected Outline:
              </Typography>
              <Typography variant="h6" gutterBottom>
                {outlinePoints.find((o) => o.number === selectedOutline)
                  ?.title || "Unknown"}
              </Typography>
              <Typography variant="body2" color="text.secondary">
                {outlinePoints.find((o) => o.number === selectedOutline)
            ...
            <Typography variant="body2" color="text.secondary">
              Your new passage will be generated based on this outline point.
              You'll be able to edit it once it's created.
            </Typography>
          </>
        )}
      </DialogContent>
