  ...
  return (
    <div className="text-center text-gray-700">
      ...
      <p className="font-bold mt-5 text-gray-500 text-lg font-['Arial', sans-serif]">
        Our AI-powered story generator, that <br /> can take that spark and turn it into an incredible tale in just one <br /> minute.
      </p>
      <Image
        src={dash}
      ...
      <div className="grid w-3/5 grid-cols-2 gap-4 pl-20 pr-20 mx-auto mt-8">
        ...
        <div className="relative w-5/6 h-auto max-w-xl p-6 mx-auto bg-white shadow-lg min-h-10 rounded-3xl">
          <h1 className="text-2xl font-bold leading-tight text-amber-500">Generate stories within 60 seconds</h1>
          ...
          <Lightning
            className="absolute w-1/6 h-auto bottom-5 right-4"
          />
        </div>
        {/* Feature Card 2 */}
        <div className="w-5/6 h-auto max-w-xl p-6 mx-auto bg-white shadow-lg min-h-10 rounded-3xl">
          <h1 className="text-2xl font-bold leading-tight text-blue-500">Discover</h1>
          <p className="pt-5 text-xl text-gray-600">
