...
from app.storywriter.draft.schema import PassageContext, GeneratedPassage
...
class PassageRewriterS:
    ...
    def check_narrative_perspective(self, text: str) -> float:
        """
    ...
    async def rewrite(self, 
        ...
        async def score_passage(passage: GeneratedPassage) -> Tuple[GeneratedPassage, float]:
            ...
            semantic_coherence = self.calculate_semantic_coherence(text, context.recent_passage, model=self.coherence_model)
